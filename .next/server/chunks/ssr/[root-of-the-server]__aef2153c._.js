...
"[project]/src/app/components/chatbot/createChatcompletion.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function createChatCompletion(messages) {
    ...
    const BASE_URL = process.env.API_URL || 'http://localhost:3001'; // fallback to localhost if not found
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$chatbot$2f$createChatcompletion$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/chatbot/createChatcompletion.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ChatPopup() {
    ...
    const handleMessage = async ()=>{
        ...
        setLoading(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$chatbot$2f$createChatcompletion$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])([
                ...messages,
                userMessage
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aef2153c._.js.map